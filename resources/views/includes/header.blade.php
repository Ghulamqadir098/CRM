                        ...
                        <a href="javascript:;" class="group relative" @click="toggle()">
                            <span
                                ><img
                                    ...
                                    src={{Auth::user()->image??'/assets/images/user-profile.jpeg' }}
                                    alt="image"
                            /></span>
                        </a>
                        <ul
                        ...
                        >
                            <li>
                                <div class="flex items-center px-4 py-4">
                                    <div class="flex-none">
                                        <img class="h-10 w-10 rounded-md object-cover" src={{Auth::user()->image??'/assets/images/user-profile.jpeg' }} alt="image" />
                                    </div>
                            ...
                            <li>
                                ...
                                <a href="{{ route('edit.profile')}}" class="dark:hover:text-white" @click="toggle">
                                    <svg
                            ...
                            <li>
                                ...
                                <button  onclick="openModal({{ Auth::user()->id }})" class="dark:hover:text-white" @click="toggle">   
                                    <svg
                                        class="h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2"
                                        width="18"
                                        height="18"
                            ...
                            <li class="border-t border-white-light dark:border-white-light/10">
                                <a href="{{ route('logoutweb') }}" class="!py-3 text-danger" @click="toggle">
                                    <svg
