...
@section('content')
<div class="my-auto">
    <form action="{{ route('update.profile') }}" method="POST" enctype="multipart/form-data" class="mb-5 rounded-md border border-[#ebedf2] bg-white p-4 dark:border-[#191e3a] dark:bg-[#0e1726]">
        @csrf
        ...
        <div class="flex flex-col sm:flex-row">
            ...
            <div class="grid flex-1 grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input id="name" name="name" type="text" value="{{ $user->name }}" placeholder="Enter Name" class="form-input">
                    @error('name')
                ...
                <div>
                    ...
                    <input id="email" name="email" type="email" value="{{ $user->email }}" placeholder="Enter Email" class="form-input">
                    @error('email')
                        <span class="text-danger text-sm">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input id="phone" name="phone" type="text" value="{{ $user->phone }}" placeholder="Enter Phone no" class="form-input">
                    @error('phone')
                        <span class="text-danger text-sm">{{ $message }}</span>
                    @enderror
                </div>
                <div>
                    ...
                    <input id="address" name="address" type="text" value="{{ $user->address }}" placeholder="Enter Address" class="form-input">
                    @error('address')
                        <span class="text-danger text-sm">{{ $message }}</span>
                    @enderror
                </div>
                <div>
                    ...
                    <input id="company" name="company" type="text" value="{{ $user->company }}" placeholder="Enter Company" class="form-input">
                    @error('company')
                        <span class="text-danger text-sm">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <img src="{{ $user->image ?? 'assets/images/profile-34.jpeg' }}" alt="image" class="mx-auto h-20 w-20 rounded-full object-cover md:h-32 md:w-32">
                ...
                <div class="mt-3 flex justify-end sm:col-span-2">
                    <button class="mr-3"><a href="{{ route('dashboardweb') }}" class="btn btn-md btn-danger">Cancel</a></button>
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        <div class="mb-10">
                            <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">
                                Update Profile</h1>
                            <p class="text-base font-bold leading-normal text-white-dark">Enter your details to
                                Update Profile</p>
                        </div>
                        <form action="{{ route('update.profile') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div>
                                <label for="Email">Email</label>
                                <div class="relative text-white-dark">
                                    <input name="email" type="email" value="{{ $user->email }}" placeholder="Enter Email"
                                        class="form-input ps-10 placeholder:text-white-dark" />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path opacity="0.5"
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input name="phone" type="text" value="{{ $user->phone }}" placeholder="Enter Phone no"
                                        class="form-input ps-10 placeholder:text-white-dark" />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path opacity="0.5"
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input name="address" type="text" value="{{ $user->address }}" placeholder="Enter Address"
                                        class="form-input ps-10 placeholder:text-white-dark" />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path opacity="0.5"
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input name="company" type="text" value="{{ $user->company }}" placeholder="Enter Company"
                                        class="form-input ps-10 placeholder:text-white-dark" />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path opacity="0.5"
                            ...
                            <div>
                                ...
                                <img src="{{ $user->image }}" alt="image" class="w-20 h-20">
                                <div class="relative text-white-dark">
                                    <input name="image" type="file" accept="image/*" placeholder="Enter Email"
                                        class="form-input ps-10 placeholder:text-white-dark" />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path opacity="0.5"
