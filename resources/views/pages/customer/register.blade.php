                ...
                <div
                    ...
                    <div
                        ...
                        <div class="w-full max-w-[440px] lg:mt-16">
                            ...
                            <form action="{{ route('customer.form.post') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div>
                                    ...
                                    <div class="relative text-white-dark">
                                        <input name="phone" type="text" value="{{ old('phone') }}" placeholder="Enter Phone no"
                                            class="form-input ps-10 placeholder:text-white-dark" />
                                        <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                <path opacity="0.5"
                                ...
                                <div>
                                    ...
                                    <div class="relative text-white-dark">
                                        <input name="address" type="text" value="{{ old('address') }}" placeholder="Enter Address"
                                            class="form-input ps-10 placeholder:text-white-dark" />
                                        <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                <path opacity="0.5"
                                ...
                                <div>
                                    ...
                                    <div class="relative text-white-dark">
                                        <input name="company" type="text" value="{{ old('company') }}" placeholder="Enter Company"
                                            class="form-input ps-10 placeholder:text-white-dark" />
                                        <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                <path opacity="0.5"
                                ...
                                <div>
                                    ...
                                    <div class="relative text-white-dark">
                                        <input name="image" type="file" placeholder="Enter Email"
                                            class="form-input ps-10 placeholder:text-white-dark" />
                                        <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                <path opacity="0.5"
