            ...
            <div x-data="auth">
                ...
                >
                    ...
                    >
                        ...
                        <div class="relative mx-auto flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                            ...
                            <div class="w-full max-w-[440px] lg:mt-16">
                                ...
                                <form action="{{ route('login.post') }}" method="POST" class="space-y-5 dark:text-white">
                                    @csrf
                                    <div>
